...
```text
npx skills@latest add https://github.com/ScotTFO/you-suck-at-prompting/tree/v0.15.1
```

The release checks pin the installer as well:

```text
npx skills@1.5.23 add https://github.com/ScotTFO/you-suck-at-prompting/tree/v0.15.1 --agent '*' --copy --yes
```
