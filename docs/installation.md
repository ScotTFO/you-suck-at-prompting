...
```text
npx skills@latest add https://github.com/ScotTFO/you-suck-at-prompting/tree/v0.10.0
```

The private release gate pins the installer as well:

```text
npx skills@1.5.23 add https://github.com/ScotTFO/you-suck-at-prompting/tree/v0.10.0 --agent '*' --copy --yes
```
